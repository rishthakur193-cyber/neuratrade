...
const TREND_MAP = (score) => score >= 80 ? 'HOT' : score >= 65 ? 'RISING' : score >= 50 ? 'STABLE' : score >= 35 ? 'COOLING' : 'WEAK';
const TREND_COLORS = {
...
export class StrategyIntelligenceService {
    static async getIntelligence() {
        ...
        const strategies = ['INTRADAY', 'OPTIONS', 'SWING', 'POSITIONAL', 'MOMENTUM', 'SCALPING'];
        const rankings = strategies.map((s, i) => {
