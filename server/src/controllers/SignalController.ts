...
export const publishSignal = async (req: AuthRequest, res: Response) => {
    try {
        ...
        if (!advisor) return res.status(403).json({ message: 'Only advisors can publish signals' });
...
export const getActiveSignals = async (req: AuthRequest, res: Response) => {
    try {
...
export const closeSignal = async (req: AuthRequest, res: Response) => {
    try {
